...
const FeaturedProjects = () => {
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Istio', 'Kubernetes', 'gRPC', 'Redis'],
      duration: '6 months',
      team: '8 engineers',
      status: 'in-progress',
    ...
    },
    {
      ...
      technologies: ['Vault', 'Falco', 'OPA', 'Twistlock'],
      duration: '3 months',
      team: '3 engineers',
      status: 'planning',
      category: 'Security'
    },
    {
      ...
      technologies: ['AWS', 'Terraform', 'Lambda', 'RDS'],
      duration: '5 months',
      team: '6 engineers',
      status: 'completed',
      category: 'Cloud'
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Explore my portfolio of DevOps and cloud infrastructure projects, showcasing 
            real-world solutions and innovative implementations.
          </p>
          <Link
            to="/projects"
          ...
          {projects.slice(0, 6).map((project) => (
            ...
            >
              <Link to={`/project/${project.id}`}>
                <div className="bg-gray-700 rounded-xl overflow-hidden border border-gray-600 hover:border-cyan-500 transition-all duration-300 h-full">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 bg-gray-800 bg-opacity-80 text-cyan-400 text-xs font-medium rounded-full">
                        {project.category}
                      </span>
                    </div>
                  </div>
